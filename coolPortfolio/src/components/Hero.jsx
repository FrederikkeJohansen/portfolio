  ...
  return (
    <div className="mx-auto flex flex-col items-center md:pt-16 lg:pt-24 mb-16">
      ...
      <p className="text-center font-extralight text-base sm:text-lg md:text-xl lg:text-xl max-w-2xl mx-auto">
        Hi! - I'm a MSc graduate in IT Product Development from Aarhus University with interests in <span className="brush-highlight"> hardware, front-end development, and UI/UX design. </span> While I'm still early
